    ...
    public class InternetMessage : HeaderBodyMessage
    {
        ...
        public virtual InternetInstructionFragmentBase Instruction
        {
            get
            {
                ...
                {
                    mInstruction = PoolGetObject(FragmentHeaderInitialType) as InternetInstructionFragmentBase;
        ...
        protected override void FragmentCollectionComplete()
        {
            ...
            MessageCRLFFragment terminator = PoolGetObject(typeof(MessageCRLFFragment)) as MessageCRLFFragment;
            ...
            foreach (IXimuraMessage frag in mMessageParts.Values)
                frag.EndInit();
