...
namespace Ximura.Data
{
    ...
    public partial class XmlContent : XmlContentBase
    {
		...
		/// </summary>
		public XmlContent():this((IContainer)null)
        {
        }
		/// <summary>
        ...
        public XmlContent(System.ComponentModel.IContainer container)
            : base(container)
		{
		}
        /// <summary>
        ...
        public XmlContent(SerializationInfo info, StreamingContext context)
            :
            base(info, context) 
        { 
        }
