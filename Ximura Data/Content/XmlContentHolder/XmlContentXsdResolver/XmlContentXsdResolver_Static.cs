...
namespace Ximura.Data
{
    public partial class XmlContentXsdResolver : XmlResolver
    {
        ...
        private static Dictionary<Type, XmlContentXsdResolver> mResolverCache;
        ...
        static XmlContentXsdResolver()
        {
            mResolverCache = new Dictionary<Type, XmlContentXsdResolver>();
        ...
        public static XmlContentXsdResolver GetResolver(Type dataContentType)
        {
            ...
            lock (syncXSDLock)
            {
                if (mResolverCache.ContainsKey(dataContentType))
                    return mResolverCache[dataContentType];
                XmlContentXsdResolver newResolver = new XmlContentXsdResolver(dataContentType);
