...
namespace Ximura.Windows
{
    ...
    /// </summary>
    public class ServiceStartException : XimuraException
    {
        /// <summary>
        /// Initializes a new instance of the LogonException class.
        /// </summary>
        public ServiceStartException() : base() { }
        /// <summary>
        /// Initializes a new instance of the LogonException class.
        /// </summary>
        ...
        public ServiceStartException(string message, Exception ex) : base(message, ex) { }
        /// <summary>
