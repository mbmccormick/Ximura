...
namespace Ximura.Windows
{
    ...
    public class HostAppServerAttribute: System.Attribute
    {
        /// <summary>
        ...
        public HostAppServerAttribute(int Priority, string Name, Type ServerType):this(Priority,Name,ServerType,true)
        {
        }
        /// <summary>
        /// This constructor sets the basic parameters for the application.
        ...
        public HostAppServerAttribute(int Priority, string Name, Type ServerType, bool Enabled)
        {
