...
namespace Ximura.Collections
{
    ...
    public class ConcurrentListHTS<T> : ConcurrentList<T, HashTableStructBasedVertexArray<T>>
    {
        #region Constructor
        /// <summary>
        /// This is the default constructor. The collection will be constructed with a base capacity of 1000.
        /// </summary>
        public ConcurrentListHTS()
        ...
        public ConcurrentListHTS(IEnumerable<T> collection) : base(null, 1000, collection, false) { }
        ...
        public ConcurrentListHTS(IEnumerable<T> collection, bool isFixedSize) : base(null, isFixedSize ? -1 : 1000, collection, isFixedSize) { }
        ...
        public ConcurrentListHTS(IEqualityComparer<T> comparer, IEnumerable<T> collection)
        ...
        public ConcurrentListHTS(int capacity)
        ...
        /// <param name="capacity">The collection initial capacity.</param>
        /// <param name="isFixedSize">The collection is fixed to the size passed in the capacity parameter.</param>
        public ConcurrentListHTS(int capacity, bool isFixedSize)
        ...
        /// If this is set to null the default comparer for the type will be used instead./</param>
        /// <param name="capacity">The collection initial capacity.</param>
        public ConcurrentListHTS(IEqualityComparer<T> comparer, int capacity)
        ...
        /// <param name="capacity">The collection initial capacity.</param>
        /// <param name="isFixedSize">The collection is fixed to the size passed in the capacity parameter.</param>
        public ConcurrentListHTS(IEqualityComparer<T> comparer, int capacity, bool isFixedSize)
        ...
        /// <param name="capacity">The collection initial capacity.</param>
        /// <param name="collection">The values in this enumeration will be loaded in to the collection.</param>
        public ConcurrentListHTS(IEqualityComparer<T> comparer, int capacity, IEnumerable<T> collection)
        ...
        /// <param name="collection">The values in this enumeration will be loaded in to the collection.</param>
        /// <param name="isFixedSize">The collection is fixed to the size passed in the capacity parameter.</param>
        public ConcurrentListHTS(IEqualityComparer<T> comparer, int capacity, IEnumerable<T> collection, bool isFixedSize)
            : base(comparer, capacity, collection, isFixedSize) { }
        #endregion // Constructor
    }
    #endregion // ConcurrentListHTS
    ...
    /// <typeparam name="T">The collection item type.</typeparam>
    [DebuggerDisplay("Count = {Count}"), HostProtection(SecurityAction.LinkDemand, MayLeakOnAbort = true)]
    public class ConcurrentListSLC<T> : ConcurrentList<T, SkipListClassBasedVertexArray<T>>
    {
        #region Constructor
        /// <summary>
        /// This is the default constructor. The collection will be constructed with a base capacity of 1000.
