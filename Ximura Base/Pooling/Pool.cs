...
namespace Ximura
{
        ...
        where T : IXimuraPoolableObject
    {
        ...
        private void CheckStatus()
        {
            if (mDisposed)
            {
                throw new ObjectDisposedException(GetType().ToString(), "The object pool has been disposed off already.");
            }
        ...
        {
            get { return mPoolManager; }
            set { mPoolManager = value; }
        }
        #endregion
