...
namespace Ximura
{
    ...
    /// </summary>
    public class MessageStreamBase : MessageBase, IXimuraMessage, IXimuraMessageStreamLoad
    {
        #region Declarations
        /// <summary>
        ...
        {
            if (Loaded)
                throw new MessageLoadException("The message cannot be loaded.");
