...
namespace Ximura
{
    ...
    public class Message : MessageStreamBase, IXimuraMessageStream, IXimuraPoolManagerDirectAccess
    {
        ...
        {
            IXimuraMessage fragment = FragmentGet(fragmentType);
        ...
        protected virtual IXimuraMessage FragmentGet(Type fragmentType)
        {
            if (PoolManager == null)
                return RH.CreateObjectFromType(fragmentType) as IXimuraMessage;

            return this.PoolGetObject(fragmentType) as IXimuraMessage;
        }
        #endregion  
