...
namespace Ximura
{
    ...
    /// </summary>
    public class CSVTerminationMatchCollectionState : MatchCollectionState<byte, byte>
    {
        #region Declarations
        ...
        /// </summary>
        public CSVTerminationMatchCollectionState():this(true)
        {
        }
        /// <summary>
        ...
        public CSVTerminationMatchCollectionState(bool AllowFolding)
        {
        ...
        {
            return new CSVMatchCollection(mAllowFolding);
        }
        #endregion
        ...
        /// </summary>
        public class CSVMatchCollection : MatchCollection<byte, byte>
        {
            ...
            /// </summary>
            /// <param name="boundary"></param>
            internal CSVMatchCollection(bool AllowFolding)
                : base(null)
            {
                mAllowFolding = AllowFolding;
            }
