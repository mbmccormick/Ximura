...
namespace Ximura.Persistence
{
    ...
    public class FileSystemStorageManagerConfiguration: StorageManagerConfiguration
    {
        ...
        /// </summary>
        public FileSystemStorageManagerConfiguration() : this((IContainer)null) { }
        /// <summary>
        ...
        public FileSystemStorageManagerConfiguration(System.ComponentModel.IContainer container)
            :
            base(container) { }
        /// <summary>
        ...
        public FileSystemStorageManagerConfiguration(SerializationInfo info, StreamingContext context)
            :
            base(info, context) { }
        #endregion
