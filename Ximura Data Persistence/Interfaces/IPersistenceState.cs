...
{
    /// <summary>
    /// This interface is implemented by persistence states.
    /// </summary>
    public interface IPersistenceState : IXimuraFSMStateIdentifier
    {
        /// <summary>
        /// This method can be used to initialize the request.
        /// </summary>
        /// <param name="context">The job context.</param>
        void Initialize(IPersistenceContext context);
        /// <summary>
        ...
        /// </summary>
        /// <param name="context">The job context.</param>
        void Finish(IPersistenceContext context);
