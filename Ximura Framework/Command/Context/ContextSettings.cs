...
namespace Ximura.Framework
{
        ...
        where PERF : FSMCommandPerformance, new()
    {
        ...
        #region SignalCompletion(IXimuraFSMContext context)
        /// <summary>
        ...
        #endregion // SignalCompletion(IXimuraFSMContext context)
        ...
        public virtual void InitializeSettings(IXimuraCommand baseCommand,
            ...
            IXimuraEnvelopeHelper envelopeHelper,
        ...
        #region ResolveConnectionString(string connID)
        /// <summary>
        ...
        #endregion // ResolveConnectionString(string connID)
