...
{
    /// <summary>
    /// This is the Register verb for the SIP Protocol.
    /// </summary>
    public class RegisterSIP: Verb
    {
        #region Constructors
        /// <summary>
        /// Empty constructor for use by the component model.
        /// </summary>
        public RegisterSIP() : this(null) { }
        ...
        public RegisterSIP(System.ComponentModel.IContainer container)
            : base(container)
        {
        }
        #endregion
