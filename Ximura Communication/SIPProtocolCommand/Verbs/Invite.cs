...
{
    /// <summary>
    /// This is the Invite verb for the SIP Protocol.
    /// </summary>
    public class InviteSIP: Verb
    {
        #region Constructors
        /// <summary>
        /// Empty constructor for use by the component model.
        /// </summary>
        public InviteSIP() : this(null) { }
        ...
        public InviteSIP(System.ComponentModel.IContainer container)
            : base(container)
        {
        }
        #endregion
