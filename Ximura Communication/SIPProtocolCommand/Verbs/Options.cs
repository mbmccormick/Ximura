...
{
    /// <summary>
    /// This is the Options verb for the SIP Protocol.
    /// </summary>
    public class OptionsSIP : Verb
    {
        #region Constructors
        /// <summary>
        /// Empty constructor for use by the component model.
        /// </summary>
        public OptionsSIP() : this(null) { }
        ...
        public OptionsSIP(System.ComponentModel.IContainer container)
            : base(container)
        {
        }
        #endregion
