...
{
    /// <summary>
    /// This is the Cancel verb for the SIP Protocol.
    /// </summary>
    public class CancelSIP: Verb
    {
        #region Constructors
        /// <summary>
        /// Empty constructor for use by the component model.
        /// </summary>
        public CancelSIP() : this(null) { }
        ...
        public CancelSIP(System.ComponentModel.IContainer container)
            : base(container)
        {
        }
        #endregion
