...
namespace XIMS.Communication
{
    ...
    /// </summary>
    public class FTPProtocolCommand: ProtocolCommand
    {
        #region Constructors
        /// <summary>
        /// Empty constructor for use by the component model.
        /// </summary>
        public FTPProtocolCommand() : this(null) { }
        /// <summary>
        ...
        public FTPProtocolCommand(System.ComponentModel.IContainer container)
            : base(container)
        {
        }
        #endregion
